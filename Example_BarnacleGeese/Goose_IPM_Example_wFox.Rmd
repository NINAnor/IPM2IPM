...
image(testData$mass, testData$mass, t(growthSurvMat_f$expected), xlab = "mass(t)", ylab = "mass(t + 1)")
image(testData$mass, testData$mass, t(growthSurvMat_a$expected), xlab = "mass(t)", ylab = "mass(t + 1)")
image(testData$mass, testData$mass, t(recMat$expected), xlab = "mass(t)", ylab = "mass(t + 1)")

# Plot the expected values of the full kernel matrix
image(t(FullOut$expected),horizontal=F)
fields::image.plot(t(FullOut$expected),horizontal = FALSE)
```
