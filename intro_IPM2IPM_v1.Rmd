...
author:
- 'In random order, except boss is always first:'
...
This is now written as a simple overview of the project, and of the modelling framework. No details on coding, figures etc, as this will then overlap greatly with the pagan-vignette, and also with the examples that will be provided.
...
Link til [github repository](https://github.com/NINAnor/IPM2IPM).
